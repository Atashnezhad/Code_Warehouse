...
for i=1:SwarmNum
    ...
    %change num of para+1
    %fitness(i)=funcparameters(aa1(1,i),aa2(1,i),aa3(1,i),aa4(1,i),aa5(1,i),aa6(1,i),aa7(1,i),aa8(1,i));
    %fitness(i)=funcparameters(aa1(1,i),aa2(1,i),aa3(1,i),aa4(1,i));
    fitness(i)=funcparameters(aa1(1,i),aa2(1,i),aa3(1,i),aa4(1,i),aa5(1,i));
...
for i=1:SwarmNum
    ...
    %TV(9,i)=funcparameters(TV(1,i),TV(2,i),TV(3,i),TV(4,i),TV(5,i),TV(6,i),TV(7,i),TV(8,i));
    %TV(5,i)=funcparameters(TV(1,i),TV(2,i),TV(3,i),TV(4,i));
    TV(6,i)=funcparameters(TV(1,i),TV(2,i),TV(3,i),TV(4,i),TV(5,i));
end
%%
...
%           (inipoints(6,j)*(data(i,3)^inipoints(7,j))+inipoints(8,j));
             ...
             %((t1*data(i,2)^t4)*(data(i,1)^(t2*data(i,1)))+(t3*data(i,2)^t5))
             data(i,4)=((inipoints(1,j)*data(i,2))*(data(i,1)^(inipoints(2,j)*data(i,2)+inipoints(3,j)))+(inipoints(4,j)*data(i,2)+inipoints(5,j)));
...
scatter(getcolumn(data(:,[1,3]),1),getcolumn(data(:,[1,3]),2))
hold on

% plot(1:21,data(:,4))
% hold off

scatter(getcolumn(data(:,[1,4]),1),getcolumn(data(:,[1,4]),2))
hold off
